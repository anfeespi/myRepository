...
public class PanelPrincipal extends JPanel {
	...
	/**
	 * Boton por el cual se accede a la ventana para administrar los perros
	 */
	private JButton b_perro;
	/**
	 * Boton por el cual se accede a la ventana para administrar los gatos
	 */
	private JButton b_gato;
	/**
	...
	public void init() {
		...
		titulo = new JLabel("Perreo & Gateo");
		titulo.setFont(f);
		titulo.setBounds(410, 100, 300, 30);
		titulo.setVisible(true);
		
		b_perro = new JButton("Op. Perros");
		b_perro.setBounds(100, 400, 300, 50);
		b_perro.setFont(f2);
		b_perro.setBackground(new Color(255, 233, 174));
		b_perro.setVisible(true);
		
		b_gato = new JButton("Op. Gatos");
		b_gato.setBounds(600, 400, 300, 50);
		b_gato.setFont(f2);
		b_gato.setBackground(new Color(255, 233, 174));
		b_gato.setVisible(true);
